    ...
    <Section id="home" className="min-h-screen flex items-center justify-center pt-20">
      <div className="text-center relative z-10">
        ...
        <h1 className="font-display text-5xl md:text-7xl lg:text-9xl font-bold tracking-tight mb-6 leading-tight">
          P. <span className="bg-clip-text text-transparent bg-gradient-to-r from-neon-blue via-neon-purple to-neon-cyan animate-pulse">Vyshnavi</span> Royal
        </h1>
        
        <p className="max-w-2xl mx-auto text-lg md:text-xl text-slate-600 dark:text-slate-300 leading-relaxed mb-10">
          Computer Science Student specializing in <strong className="text-neon-purple">AI/ML</strong> and <strong className="text-neon-cyan">Full-Stack Development</strong>. 
          Building scalable solutions for the world of tomorrow.
        </p>
