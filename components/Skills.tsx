...
const Skills: React.FC = () => {
  const skills = [
    { category: 'Programming', items: ['Python', 'JavaScript', 'C++'], color: 'text-blue-400' },
    { category: 'Web Tech', items: ['React.js', 'Node.js', 'HTML5', 'CSS3'], color: 'text-neon-cyan' },
    { category: 'Databases', items: ['MongoDB', 'MySQL'], color: 'text-green-400' },
    { category: 'Tools', items: ['VS Code', 'Google Colab', 'Git'], color: 'text-purple-400' },
  ];
